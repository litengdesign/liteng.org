<div class="grid-container">
  <!--header-->
  <header id="header" class="grid-20 text-right mobile-grid-95">
  ...
  <?php if($messages): ?>
    <div class="grid-60 prefix-20 mobile-grid-100">
  ...
  <!--wrap-->
  <?php if($is_front): ?>
    <div id="wrap" class="grid-60 prefix-20 mobile-grid-100">
    ...
    <div id="object-tags" class="object-tags grid-10  hide-on-mobile">
      <h3>标签墙/Tags Wall</h3>
      <?php print render($page['sidebar_second']); ?>
    </div>   
  <?php endif ?>
  <?php if ( !$is_front ): ?>
    <div id="wrap" class="grid-60 prefix-20 text-left mobile-grid-100">
    ...
    <footer class="footer">
      ...
      <p>Think you <a href="http://www.drupal.org">drupal</p>    
    </footer>
